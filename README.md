...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=3000&pause=1000&color=9D4EDD&center=true&vCenter=true&width=600&lines=CS+student+%C2%B7+systems+%26+backend;distributed+systems%2C+built+from+scratch;self-hosted%2C+because+I+want+to+know+why+it+broke;it's+not+paranoia+if+it's+engineered;feature+or+bug%3F+%7C+yes" alt="Typing SVG" />
...
Fourth-year Computer Science student at UNS (Argentina) who got tired of things breaking in weird ways and decided to understand them instead.

I like systems that are **transparent**, tools that are **composable**, and infrastructure that doesn't mysteriously fail at 3 AM. Self-hosting is less about paranoia and more about "well, at least when *this* breaks, I know whose fault it is."

```yaml
focus: "distributed systems, networking, the low-level stuff"
approach: "fix it properly or document why you didn't"
motto: "it's not paranoia if they're actually collecting your data"
currently: "4th year of 5, open to remote internships / part-time"
will_automate: "anything I have to do more than once"
